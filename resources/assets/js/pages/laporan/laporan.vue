        ...
        <v-stepper v-model="step">
          ...
          <v-stepper-items>
            ...
            <v-stepper-content step="3">
                <LaporanReguler laporan_tipe="reguler" :allProses="allProses" :pol="pol" :proses="proses" :proses_ke="proses_ke" :step="step" ></LaporanReguler>
            </v-stepper-content>
          </v-stepper-items>
        </v-stepper>
      </v-flex>
...
export default {
  ...
  methods: {
    ...
    ambilPol() {
      ...
      axios.get("api/data/pol/reguler/" + cari+'/'+this.status+ "?page=" + this.page).then(response => {
